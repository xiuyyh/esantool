        ...
        <div className="max-w-screen-2xl px-10 text-center mx-auto">
          <div className="flex items-center justify-center space-x-4 mb-10">
            ...
            <div className="text-left">
              ...
              <span className="font-mono text-[9px] uppercase tracking-[0.4em] text-accent/60">Professional Node Marketplace</span>
            </div>
          </div>
          <div className="flex flex-col items-center gap-2 opacity-40 font-mono text-[10px] uppercase tracking-[0.2em]">
            <p>Direct encrypted transmission protocol active.</p>

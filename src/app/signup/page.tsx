      ...
      <Card className="w-full max-w-2xl glass-card border-white/10 relative overflow-hidden">
        ...
        <CardHeader className="space-y-6 text-center pb-8 pt-10">
          ...
          <div className="space-y-2">
            <CardTitle className="font-headline text-4xl font-bold uppercase tracking-tight">Sign Up</CardTitle>
        ...
        <CardContent className="space-y-8 px-8 sm:px-12">
          <form onSubmit={handleSignup} className="space-y-6">
            ...
            <div className="space-y-3">
              <Label htmlFor="password" title="password" className="text-xs font-bold uppercase tracking-widest text-muted-foreground ml-1">Create Password</Label>
              <div className="relative group">

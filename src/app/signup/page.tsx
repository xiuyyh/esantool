    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4">
      <Card className="w-full max-w-2xl glass-card border-white/10 relative overflow-hidden">
        ...
        <CardHeader className="space-y-1 text-center pb-2 pt-4">
          <div className="mx-auto bg-accent/10 p-2 rounded-xl w-fit mb-1 shadow-inner">
        ...
        <CardContent className="space-y-3 px-8 sm:px-12 pb-4">
          <form onSubmit={handleSignup} className="space-y-3">
            <div className="space-y-1">
              <Label htmlFor="name" className="text-[9px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Full Name</Label>
              <div className="relative group">
                ...
                <Input 
                  ...
                  className="h-10 pl-12 glass-card border-white/10 focus:border-accent/30 focus:ring-accent/20 transition-all" 
                  value={name}
            ...
            <div className="space-y-1">
              <Label htmlFor="email" className="text-[9px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Email Address</Label>
              <div className="relative group">
            ...
            <div className="space-y-1">
              <Label htmlFor="password" title="password" className="text-[9px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Create Password</Label>
              <div className="relative group">
            ...
            <Button 
              type="submit" 
              className="w-full h-11 bg-primary hover:bg-primary/90 text-primary-foreground font-bold text-base uppercase tracking-widest mt-1 shadow-lg shadow-primary/20 transition-transform active:scale-[0.98]"
              disabled={loading}
            >
        ...
        <CardFooter className="pb-4 pt-2 flex flex-col space-y-2">
          <div className="w-full h-px bg-white/5 mb-2"></div>
          <p className="text-center w-full text-[10px] text-muted-foreground">

      ...
      <Card className="w-full max-w-2xl glass-card border-white/10 relative overflow-hidden">
        ...
        <CardHeader className="space-y-2 text-center pb-4 pt-6">
          ...
          <div className="space-y-1">
            <CardTitle className="font-headline text-2xl font-bold uppercase tracking-tight">Login</CardTitle>
        ...
        <CardContent className="space-y-4 px-8 sm:px-12">
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="password" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Your Password</Label>
              <div className="relative group">
